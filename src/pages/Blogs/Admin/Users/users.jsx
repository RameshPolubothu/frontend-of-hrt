...
import { useDeleteUserMutation, useGetUserQuery } from '../../../../redux/features/authenticatio/Authapi';
                ...
                <tbody>
                    {
                        ...
                        <tr key = {index}>
                            ...
                            ${user?.role === 'admin' ? "bg-indigo-500 text-white":"bg-amber-300 text-white"} `}>
                            {user?.role}
                            </span>    
                            </td>
                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
